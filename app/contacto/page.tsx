...
const benefits = [
  { icon: "fas fa-tag", title: "Mejores Precios", description: "Sin comisiones de terceros" },
  { icon: "fas fa-clock", title: "Respuesta Rápida", description: "Confirmación inmediata" },
  { icon: "fas fa-heart", title: "Atención Personal", description: "Trato directo con los dueños" },
]
...
- Mensaje: ${formData.mensaje}`
      ...
      window.open(`https://wa.me/56982222698?text=${encodeURIComponent(message)}`, "_blank")
    }, 1000)
  }
      ...
      <section className="contacto-hero">
        ...
        <div className="contacto-hero__content">
          ...
          <p className="contacto-hero__description">
            ¿Listo para vivir una experiencia única en la naturaleza? Contáctanos para reservar tu cabaña en El Radal,
            Molina. Respuesta rápida garantizada y atención personalizada.
          </p>
          <Link href="/precios" className="contacto-hero__cta">
      ...
      <main className="contacto-main">
        ...
        <section className="contacto-form-section">
          ...
          <p className="contacto-form-section__description">
            Completa el formulario y nos pondremos en contacto contigo a la brevedad. Todos los campos marcados con *
            son obligatorios.
          </p>
          ...
          {submitSuccess ? (
            <div className="contacto-success">
              ...
              <button className="contacto-success__btn" onClick={() => setSubmitSuccess(false)}>
            ...
            <form className="contacto-form" onSubmit={handleSubmit}>
              ...
              <div className="contacto-form__group contacto-form__group--checkbox">
                <label className="contacto-form__checkbox-label">
                  ...
                  />
                  <span>
                    Acepto la <a href="#">política de privacidad</a> y autorizo el tratamiento de mis datos para fines
                    de contacto y reserva. *
                  </span>
                </label>
              </div>

              <button type="submit" className="contacto-form__submit" disabled={isSubmitting}>
                {isSubmitting ? (
                  <>
