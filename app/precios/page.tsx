...
const promotions = [
  { icon: "fas fa-calendar-week", title: "Semana Completa", description: "7 noches o más", discount: "15%" },
  { icon: "fas fa-users", title: "Grupo Familiar", description: "3 cabañas o más", discount: "10%" },
  { icon: "fas fa-heart", title: "Cliente Frecuente", description: "Tercera visita", discount: "20%" },
]
      ...
      <section className="precios-hero">
        ...
        <div className="precios-hero__content">
          ...
          <p className="precios-hero__description">
            Descubre nuestras tarifas 2025 para Cabañas Santa Camila. Precios justos y transparentes para tu estadía
            en El Radal, Molina. Reserva directa sin comisiones adicionales.
          </p>
          <button className="precios-hero__cta" onClick={() => openBooking()}>
        ...
        <section className="precios-cards">
          ...
          <div className="precios-cards__grid">
            {cabins.map((cabin, index) => (
              <article key={index} className={`precios-card ${cabin.featured ? "precios-card--featured" : ""}`}>
                {cabin.featured && (
                ...
                <button className="precios-card__cta" onClick={() => openBooking()}>
        ...
        <section className="precios-cta">
          <div className="precios-cta__content">
            ...
            <p className="precios-cta__text">
              Contáctanos directamente para obtener información personalizada sobre descuentos, disponibilidad y
              promociones especiales.
            </p>
            <div className="precios-cta__buttons">
              <button className="precios-cta__btn precios-cta__btn--primary" onClick={() => openBooking()}>
                <i className="fas fa-calendar-check" aria-hidden="true"></i>
