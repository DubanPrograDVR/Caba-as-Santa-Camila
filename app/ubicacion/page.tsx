...
import ReservarButton from "@/components/booking/reservar-button"
import Link from "next/link"
import type { Metadata } from "next"

export const metadata: Metadata = {
  title: "Ubicación | Cabañas Santa Camila - Cómo llegar a El Radal, Molina",
  description:
    "Encuentra cómo llegar a Cabañas Santa Camila en El Radal, Molina, Región del Maule. A 15 minutos del Parque Nacional Radal Siete Tazas.",
}
        ...
        <div className="ubicacion-hero-overlay">
          <div className="container">
            ...
            <p className="ubicacion-subtitle">
              Descubre cómo llegar fácilmente a nuestras cabañas ubicadas en el corazón de El Radal, Molina, en la
              Región del Maule. Tu puerta de entrada perfecta al Parque Nacional Radal Siete Tazas.
            </p>
        ...
        <section className="points-of-interest-section">
          <div className="container">
            <div className="section-header text-center">
              ...
              <p className="section-description">Todo lo que necesitas está a minutos de distancia</p>
            </div>
            ...
            <div className="directions-grid">
              <div className="directions-info">
                <div className="direction-card">
                  ...
                  <p>
                    Cabañas Santa Camila está en <strong>Ruta K-275</strong>, sector El Radal, Molina, Región del
                    Maule. Se accede pasando el puente nuevo y luego caminas aproximadamente 300 m hacia la izquierda.
                  </p>
                  <a
                    href="https://maps.google.com/?q=-35.415001,-71.053659"
                    target="_blank"
                ...
                <div className="direction-card">
                  ...
                  <ol className="direction-steps">
                    <li>
                      Viaja desde Molina hacia Parque Nacional Radal Siete Tazas con transporte local
                      <span className="step-note">(Buses Radal Siete Tazas o Buses Hernández)</span>
                    </li>
                    <li>Baja en el sector El Radal / Río Claro, cerca del puente</li>
                    <li>Camina 300 m hacia la izquierda tras cruzar el puente</li>
                  </ol>
                  <div className="tip-box">
                    <i className="fas fa-lightbulb"></i>
                    <span>Tip: También puedes acordar que te recojamos en el paradero</span>
                  </div>
                </div>
              </div>
              ...
              <div className="map-container">
                ...
                <div className="map-wrapper">
                  <iframe
                    ...
                    title="Mapa de Cabañas Santa Camila"
                  ></iframe>
                </div>
          ...
          <div className="container">
            <div className="ubicacion-cta-content">
              <div className="cta-text">
                ...
                <p>Reserva ahora y vive la experiencia de desconectarte en plena naturaleza</p>
              </div>
              <div className="cta-actions">
                <ReservarButton className="btn-reservar-cta">
                  <i className="fas fa-calendar-check"></i>
                  Reservar Ahora
                </ReservarButton>
                <Link href="/" className="btn-ver-cabanas">
