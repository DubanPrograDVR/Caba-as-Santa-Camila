      ...
      <div className="container">
        ...
        <div className="testimonios-section">
          <div className="section-intro">
            ...
            <p className="section-description">Lee lo que nuestros huéspedes dicen sobre su estadía</p>
          </div>
          ...
          <div className="testimonios-grid">
            <div className="testimonio-card">
              ...
              <p className="testimonio-text">
                &quot;Increíble experiencia familiar. Los niños no querían irse del río y nosotros tampoco de
                la tranquilidad. ¡Volveremos sin dudas!&quot;
              </p>
            ...
            <div className="testimonio-card featured">
              ...
              <div className="testimonio-rating">★★★★★</div>
              <p className="testimonio-text">
                &quot;La cabaña tenía todo lo necesario. Despertarse con el sonido del río es una experiencia
                que no se paga con nada. Atención impecable.&quot;
              </p>
              <div className="testimonio-footer">
                <div className="testimonio-author">
                  <div className="author-avatar">
            ...
            <div className="testimonio-card">
              <div className="testimonio-rating">★★★★★</div>
              <p className="testimonio-text">
                &quot;Perfecta ubicación para conocer Siete Tazas. Las cabañas súper limpias y la atención de
                primera. Recomendado 100%.&quot;
              </p>
              <div className="testimonio-footer">
                <div className="testimonio-author">
                  <div className="author-avatar">
