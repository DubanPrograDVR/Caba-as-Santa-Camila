      ...
      <div className="container">
        <div className="section-intro">
          ...
          <p className="section-description">
            Más que un alojamiento, es tu puerta de entrada a la aventura y el descanso
          </p>
        </div>
        ...
        <div className="row">
          <div className="col-md-4 info-item">
            ...
            <p>
              Cabañas completamente equipadas con cocina moderna, TV cable, agua caliente 24/7 y amenidades
              de alta calidad.
            </p>
            <Link href="/precios" className="info-link">
          ...
          <div className="col-md-4 info-item">
            ...
            <p>
              Ubicación privilegiada a orillas del río y a minutos de las cascadas más impresionantes de
              Chile.
            </p>
            <Link href="/ubicacion" className="info-link">
          ...
          <div className="col-md-4 info-item">
            ...
            <p>
              Servicio familiar directo. Te asesoramos para crear la escapada perfecta según tus
              necesidades.
            </p>
            <Link href="/contacto" className="info-link">
