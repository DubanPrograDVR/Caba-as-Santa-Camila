          ...
          <div className="about-info">
            <div className="about-card">
              ...
              <div className="card-content">
                ...
                <p>
                  Cabañas Santa Camila nació del sueño de ofrecer a las familias y viajeros un refugio
                  auténtico en la naturaleza. Ubicadas en el corazón del sector El Radal, nuestras cabañas han
                  sido diseñadas para brindar la máxima comodidad mientras te conectas con los paisajes únicos
            ...
            <div className="about-card">
              ...
              <div className="card-content">
                ...
                <p>
                  Creemos en el turismo sustentable. Nuestras instalaciones respetan el entorno natural y
                  promovemos prácticas ecoamigables para preservar la belleza de El Radal para futuras
                  generaciones.
                </p>
